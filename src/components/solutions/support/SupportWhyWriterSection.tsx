...
export function SupportWhyWriterSection() {
  const { whyWriter } = supportPageData;
      ...
      <div className="mx-auto max-w-[1280px] px-5 lg:px-10">
        ...
        <div className="grid gap-[22px] md:grid-cols-2">
          {whyWriter.items.map((item, i) => (
            <article
              key={i}
              className="group flex flex-col rounded-[16px] border border-[#E4E7ED] bg-white p-8 shadow-[0_2px_0_0_#F3F3F3]"
            >
              <div className="mb-4">
                <Image
                  src={item.icon}
