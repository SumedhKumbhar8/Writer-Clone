...
export function SupportSpotlightsSection() {
  const { spotlights } = supportPageData;
      ...
      <div className="container-default-sm">
        ...
        >
          {spotlights.items.map((item, i) => (
            <article
              key={i}
              className="group flex min-w-[280px] max-w-[350px] flex-shrink-0 flex-col overflow-hidden rounded-[16px] bg-[#F5F5F9]"
            >
