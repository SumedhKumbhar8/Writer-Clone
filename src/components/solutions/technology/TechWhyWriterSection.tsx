...
export function TechWhyWriterSection() {
  const { whyWriter } = techPageData;
    ...
    <section className="bg-white py-[79px]">
      <div className="container-default-sm">
        <div className="mb-12 flex flex-col items-center text-center">
          ...
          <h2 className="mx-auto max-w-[600px] text-[clamp(28px,3.5vw,40px)] font-normal leading-[120%] text-black whitespace-pre-line">
            {whyWriter.title}
          </h2>
        </div>
        <div className="grid gap-[22px] md:grid-cols-2">
          {whyWriter.items.map((item, i) => (
            ...
            >
              ...
              <h4 className="mb-3 text-[clamp(20px,2vw,25px)] font-medium leading-[120%] text-[#252525] whitespace-pre-line">
                {item.title}
              </h4>
