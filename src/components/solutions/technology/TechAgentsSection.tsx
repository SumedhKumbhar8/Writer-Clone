...
export function TechAgentsSection() {
  const { agents } = techPageData;
    ...
    <section className="bg-[#1C1B1E] py-[70px] pb-[135px] max-lg:py-[60px]">
      <div className="mx-auto max-w-[1280px] px-5 lg:px-10">
        <div className="mb-10 max-w-[760px]">
          ...
          <p className="text-[clamp(16px,1.8vw,20px)] font-normal leading-[158.333%] text-[#828282] mt-2 max-w-[530px]">
            {agents.description}
          </p>
        </div>
        ...
        <div className="flex flex-col gap-8">
          {allSections.map((section, idx) => (
            ...
            >
              <div
                className="flex w-full flex-col p-[30px_22px] lg:max-w-[320px]"
                style={{ minHeight: 600 }}
              >
