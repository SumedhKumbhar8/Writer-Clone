...
export function SalesAgentsSection() {
  const { agents } = salesPageData;
        ...
        <div className="mb-12 inline-flex items-center rounded-[128px] border border-[#333] bg-black p-[13px_69px] shadow-[0_0_50px_0_rgba(60,100,250,0.10)] max-lg:w-full max-lg:overflow-x-auto max-lg:p-[13px_20px]">
          {agents.tabs.map((tab) => (
            <button
              ...
              className={`px-4 py-2 text-[15px] font-medium uppercase tracking-[1px] text-[#D2D4D7] transition-all whitespace-nowrap ${
                activeTab === tab.id
