export const CONNECTORS_HERO = {
  ...
  image: {
    src: "https://writer.com/wp-content/uploads/2026/05/Connectors.png",
...
export const CONNECTOR_ITEMS: ConnectorItem[] = [
  {
    ...
    category: "SEO",
    featured: true,
    featuredImage: "https://writer.com/wp-content/uploads/2026/05/Slide-16_9-167-1.png",
  },
  {
...
export const CUSTOM_CONNECTORS = {
  ...
  description:
    "Custom connectors let you bring any internal system or third-party\nservice into WRITER \u2014 with the same governance, permissions,\u2028and security as every native connector.",
  cta: { label: "Learn how", href: "https://dev.writer.com/home/custom-connectors#custom-connectors" },
  image: {
    src: "https://writer.com/wp-content/uploads/2026/05/Slide-16_9-169.png",
...
export const SECURITY_GOVERNANCE = {
  ...
  title: "Powerful enough for the business.\u2028Safe enough for IT.",
  description:
  ...
  items: [
    {
      ...
      title: "Secure, scoped access to every connected system",
      description:
    ...
    },
    {
      ...
      title: "Give every team the right access \u2014 nothing more",
      description:
    ...
    },
    {
      ...
      title: "Full visibility into what agents are doing",
      description:
    ...
    },
    {
      ...
      title: "Compliance that covers regulated industries",
      description:
...
export const FAQ_ITEMS = [
  {
    id: "ch-1",
    title: "What does MCP mean, and how does it affect the way WRITER connects to my tools?",
    content: [
  ...
  {
    id: "ch-2",
    title: "How long does it take to set up a WRITER connector, and how much IT involvement is required?",
    content: [
  ...
  {
    id: "ch-3",
    title: "How do connectors work with WRITER agents and playbooks?",
    content: [
  ...
  {
    id: "ch-4",
    title: "Does WRITER support custom connectors for internal or proprietary systems?",
    content: [
  ...
  {
    id: "ch-5",
    title: "Can WRITER respond to real-time events and triggers from connected systems, or does it only run on demand?",
    content: [
  ...
  {
    id: "ch-6",
    title: "Can WRITER connectors be configured with granular, field-level access controls?",
    content: [
  ...
  {
    id: "ch-7",
    title: "Can I restrict a connector to a specific folder, team, or data subset rather than granting broad system access?",
    content: [
